...
autoencoder = dnn.AutoEncoder(valid_data,train_data, valid_target, layers, hidden_layer="SigmoidLayer", final_layer="SoftmaxLayer", compression_epochs=1, bias=True, autoencoding_only=False, dropout_on=True)
print("1here is okay")#============================================================
autoencoder.fit()
# time end
timeend = time.time()
