...
'''
The pickled file represents a tuple of 3 lists : the training set, the validation set and the testing set.
(train, val, test)
...
from use_dbn_on_bigset import pkl_music_featuer_lable
...
def load_data(dataset):
    ...
    :type dataset: string
    :param dataset: the path to the dataset (here mfcc_sid.pkl)
    '''
    ...
    print "load dataset into three part set : train, valid, test "
    train_set, valid_set, test_set = load_dataset(dataset)
...
def sgd_optimization_mnist(learning_rate=0.13, n_epochs=500,
    ...
    classifier = LogisticRegression(input=x, n_in=95, n_out=7)
